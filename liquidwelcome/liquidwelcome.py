...
class liquidwelcome:
    ...
    async def on_member_join(self, member):
        ...
        m = (f'Hello {}! Welcome to the Official Team Liquid Mobile Discord server. We hope you have a good time here.\nPlease add the role for the game you play (+ClashRoyale, +AoV, +BrawlStars).\For anything tag an online moderator or DM Liquid Mail if you have any questions.' .format(member.mention))
