...
class liquidwelcome:
    ...
    async def on_member_join(self, member):
        ...
        m = f'Hello {}! Welcome to the Official Team Liquid Mobile Discord server. We hope you have a good time here. Please add the role for the game you play (+ClashRoyale, +AoV, +BrawlStars). Please tag a moderator and DM Liquid mail if you have any questions.' .format(member.mention)
