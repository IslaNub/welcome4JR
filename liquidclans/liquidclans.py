                            ...
                            async with session.get(url, headers=headers) as resp:
                                ...
                                try:
                                    ...
                                    if wdata['state'] in ['warDay', 'collectionDay']:
                                        ...
                                        pass
                                    embed.set_footer(text = 'LiquidClans v{} - API powered by RoyaleAPI'.format('1.0.1'), icon_url = 'https://raw.githubusercontent.com/cr-api/cr-api-docs/master/docs/img/cr-api-logo-b.png')
